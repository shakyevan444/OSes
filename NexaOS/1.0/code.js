...
function Logout() {
  setProperty("Homescreen.1", "image", "assets/800w-98aZLNQxJXg.png");
  setProperty("app.appstore.1", "image", "assets/800w-98aZLNQxJXg.png");
  setProperty("app.phone", "image", "assets/800w-98aZLNQxJXg.png");
...
onEvent("app.customizer.2.button.1", "click", function( ) {
  ...
  setProperty("app.appstore.1", "image", "assets/walper4.png");
  setProperty("app.phone", "image", "assets/walper4.png");
});
onEvent("app.settings.customizer.3.button.1", "click", function( ) {
  setProperty("Homescreen.1", "image", "assets/black_unity_22_wallpaper_iphone.png");
  setProperty("app.appstore.1", "image", "assets/black_unity_22_wallpaper_iphone.png");
  setProperty("app.phone", "image", "assets/black_unity_22_wallpaper_iphone.png");
});
onEvent("app.settings.customizer.3.button.2", "click", function( ) {
  setProperty("Homescreen.1", "image", "assets/CleanShot-2023-06-28-at-22.51.14-2x.png");
  setProperty("app.appstore.1", "image", "assets/CleanShot-2023-06-28-at-22.51.14-2x.png");
  setProperty("app.phone", "image", "assets/CleanShot-2023-06-28-at-22.51.14-2x.png");
});
...
function Seasonalwallpaper() {
  onEvent("app.customizer.2.button.3", "click", function( ) {
    setProperty("Homescreen.1", "image", "assets/Red_Background.jpg");
    setProperty("app.appstore.1", "image", "assets/Red_Background.jpg");
    setProperty("app.phone", "image", "assets/Red_Background.jpg");
  });
}
Seasonalwallpaper();
//app.appstore.1
